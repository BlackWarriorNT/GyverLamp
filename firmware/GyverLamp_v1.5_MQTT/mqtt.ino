...
int Get_EFFIDX (String effect) {
  ...
  if (effect.equals("Pride")) return 28;
  if (effect.equals("Butterflys")) return 29;
  ...
  if (effect.equals("Демо")) return 29;
